...
import { DonorActionsWorkbench } from "~~/components/bloodworks/bloodbank/DonorActionsWorkbench";

export default function BloodbankDonorActionsPage() {
  return (
    <div className="flex flex-col gap-6 max-w-3xl">
      <h1 className="text-3xl font-bold">Donor Actions</h1>
      <p className="text-sm opacity-70">
        Search a donor → issue credential → record donation.
      </p>

      <DonorActionsWorkbench />
    </div>
  );
}
